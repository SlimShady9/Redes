<template>
    <form class="w-full max-w-lg">
        ...
        <div class="md:flex md:items-center">
            <div class="md:w-1/3">
            <button class="shadow bg-gray-600 hover:bg-deep-purple-accent-200 focus:shadow-outline focus:outline-none text-white font-bold py-2 px-4 rounded" type="button">
                Enviar
            </button>
            </div>
